...
public class TrackUserActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__user_tracking);
        ...
        Intent intent = new Intent(TrackUserActivity.this, GPSService.class);
        startService(intent);
            ...
            public void onClick(View v) {
                call_layout.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        intent.setData(Uri.parse("tel:" + orderDatum.getMobile()));
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ThisApp.getApi(getApplicationContext()).pushNotification(new EventPushRequest(orderDatum.getMobile(), "" + LocalRepositories.getAppUser(getApplicationContext()).getUserDatum().getName() + " has reached")).enqueue(new Callback<PushNotificationResponse>() {
                            ...
                            public void onResponse(Call<PushNotificationResponse> call, Response<PushNotificationResponse> response) {
                                Toast.makeText(TrackUserActivity.this, "You have notified your MOM' CHEF", Toast.LENGTH_SHORT).show();
                            }

                            @Override
                            public void onFailure(Call<PushNotificationResponse> call, Throwable t) {
                                Toast.makeText(TrackUserActivity.this, "Sorry, please try again", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                })
